        ...
        <div className="md:hidden w-full px-2 sm:px-4 py-2 grid grid-cols-3 gap-1.5 sm:gap-2 shrink-0 z-[40] relative">
          <DropdownMenu modal={false}>
            <DropdownMenuTrigger asChild>
              <Button variant="default" className="w-full bg-[#6BD85E]/90 hover:bg-[#5bc250] text-black font-bold h-10 px-1 sm:px-2 rounded-xl flex items-center justify-center gap-1 backdrop-blur-md shadow-[0_0_15px_rgba(107,216,94,0.2)] transition-all duration-300">
          ...
          <Button 
            ...
            className="w-full bg-[#6BD85E]/10 hover:bg-[#6BD85E]/20 text-[#6BD85E] font-bold h-10 px-1 sm:px-2 rounded-xl flex items-center justify-center gap-1 backdrop-blur-md border border-[#6BD85E]/30 shadow-[0_0_15px_rgba(107,216,94,0.1)] transition-all duration-300"
          >
